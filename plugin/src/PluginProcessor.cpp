...
const juce::String AudioPlayerPluginProcessor::getName() const { return "JucePlugin_Name"; }
...
double AudioPlayerPluginProcessor::getTailLengthSeconds() const { return 0.0; }
...
int AudioPlayerPluginProcessor::getCurrentProgram() { return 0; }

void AudioPlayerPluginProcessor::setCurrentProgram(int index) { juce::ignoreUnused(index); }
...
void AudioPlayerPluginProcessor::changeProgramName(int index, const juce::String &newName) { juce::ignoreUnused(index, newName); }
...
void AudioPlayerPluginProcessor::processBlock(juce::AudioBuffer<float> &buffer, juce::MidiBuffer &midiMessages) {
...
juce::AudioProcessor *JUCE_CALLTYPE createPluginFilter() { return new AudioPlayerPluginProcessor(); }
...
void AudioPlayerPluginProcessor::start() { transportSource.start(); }

void AudioPlayerPluginProcessor::stop() { transportSource.stop(); }
